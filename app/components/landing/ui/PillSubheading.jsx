...
export function PillSubheading({
    text,
    icon: Icon = Stars,
    className,
    containerClassName
    ...
    return (
        <div className={cn(
            "relative mx-auto mb-6 max-w-fit rounded-full p-[1px] overflow-hidden group shadow-[0_0_20px_rgba(223,88,205,0.2)] dark:shadow-[0_0_20px_rgba(144,103,198,0.2)]",
            containerClassName
        )}>
            ...
            <div className={cn(
                "relative bg-background py-2 text-sm items-center gap-2 px-5 inline-flex text-foreground rounded-full transition-colors duration-300 z-10",
                className
            )}>
