...
function ToggleGroupItem({
  ...
  return (
    <ToggleGroupPrimitive.Item
      ...
      "transition-all duration-200 ease-in-out cursor-pointer hover:bg-transparent hover:border-ring hover:border-2 border-2 border-muted data-[state=on]:border-ring", className)}
      {...props}>
      {children}
    </ToggleGroupPrimitive.Item>
  );
